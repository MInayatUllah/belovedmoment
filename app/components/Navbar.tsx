...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="sticky top-3 z-50 mx-auto w-[95%] sm:w-[90%] md:w-[80%] max-w-7xl">
        <div className="my-1 grid w-full gap-2 rounded-full border px-3 py-2 sm:px-1.5 sm:py-1.5 md:py-0 backdrop-blur-xl transition md:pl-3 border-white/10 bg-purple-900/40">
          <div className="px-2 sm:px-4 md:px-6 lg:px-8">
            <div className="flex justify-between items-center h-10 sm:h-14 md:h-16">
              <Link href="/" className="flex items-center">
                <img src="/logos/Beloved Moment Logo transparent.svg" alt="Beloved Moment" className="h-10 sm:h-8 md:h-10" />
              </Link>
              ...
              <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
                ...
                <Link
                  href="/#Order"
                  className="bg-white hover:bg-gray-100 text-black px-4 py-2 md:px-6 md:py-2 rounded-[50px] text-sm md:text-base bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold"
                >
                  Order Now
                </Link>
              </div>
      ...
      <div className={`fixed inset-0 z-50 md:hidden transition-opacity duration-300 ${isMobileMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
        ...
        <div className={`fixed right-0 top-0 h-full w-80 bg-gradient-to-b from-purple-900/95 to-slate-900/95 backdrop-blur-xl border-l border-purple-500/30 shadow-2xl transform transition-all duration-500 ease-out ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="flex justify-between items-center p-6 border-b border-purple-500/30 bg-purple-800/20">
            <img src="/logos/Beloved Moment Logo transparent.svg" alt="Beloved Moment" className="h-10" />
