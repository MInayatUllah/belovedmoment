        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <img src="/logos/Beloved Moment Logo transparent.svg" alt="Beloved Moment" className="h-10 sm:h-10" />
            </div>
            <p className="text-purple-200 text-sm leading-relaxed mb-4">
              Transform your cherished photos into living memories with professional video editing.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/belovedmomentvideo/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center hover:from-purple-600 hover:to-pink-600 transition-all duration-200 transform hover:scale-110">
              ...
              <a href="https://www.facebook.com/profile.php?id=61585113781463" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#1877F2] rounded-full flex items-center justify-center hover:bg-[#166FE5] transition-all duration-200 transform hover:scale-110">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
