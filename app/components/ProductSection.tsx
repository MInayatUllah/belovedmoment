      ...
      <div className="relative z-10 container mx-auto px-4 max-w-5xl">
        ...
        <div className="mb-12 text-center">
          <div className="relative inline-block">
            ...
            >
              <div className="relative w-[90%] m-auto py-4 overflow-hidden">
                <div
                  className={`flex ${isTransitioning ? 'transition-transform duration-[2000ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)]' : ''}`}
                ...
                >
                  {[...videos, videos[0]].map((video, index) => (
                    <img
                      ...
                      className="w-full h-auto flex-shrink-0 object-contain max-h-[70vh]"
                    />
                  ))}
                </div>
              </div>
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <div className="w-12 h-8 bg-white rounded border border-gray-200 flex items-center justify-center p-1">
              <svg className="w-full h-full" viewBox="0 0 40 24" fill="none">
                <text x="20" y="15" textAnchor="middle" fontSize="8" fontWeight="bold" fill="#1A1F71">VISA</text>
              </svg>
            </div>
            {/* Mastercard */}
            <div className="w-12 h-8 bg-white rounded border border-gray-200 flex items-center justify-center p-1">
            ...
            <div className="w-12 h-8 bg-white rounded border border-gray-200 flex items-center justify-center p-1">
              <svg className="w-full h-full" viewBox="0 0 40 24" fill="none">
                ...
                <text x="20" y="15" textAnchor="middle" fontSize="6" fontWeight="bold" fill="white">AMEX</text>
              </svg>
            </div>
            {/* PayPal */}
            <div className="w-12 h-8 bg-white rounded border border-gray-200 flex items-center justify-center p-1">
              <svg className="w-full h-full" viewBox="0 0 40 24" fill="none">
                <text x="20" y="15" textAnchor="middle" fontSize="6" fontWeight="bold" fill="#003087">PayPal</text>
              </svg>
            </div>
            {/* Apple Pay */}
            <div className="w-12 h-8 bg-white rounded border border-gray-200 flex items-center justify-center p-1">
              <svg className="w-full h-full" viewBox="0 0 40 24" fill="none">
                <path d="M18 8c.5-.6.8-1.4.7-2.2-.7 0-1.5.5-2 1-.4.5-.8 1.3-.7 2 .8 0 1.5-.4 2-1.8M18 9c-1.1 0-2 .6-2.5.6s-1.4-.6-2.3-.6c-1.2 0-2.3.7-2.9 1.8-1.2 2.1-.3 5.2.9 6.9.6.8 1.3 1.7 2.2 1.7.9 0 1.2-.6 2.3-.6s1.3.6 2.3.6c.9 0 1.5-.8 2.1-1.6.7-.9.9-1.8.9-1.8s-1.8-.7-1.8-2.8c0-1.7 1.4-2.5 1.5-2.6-.8-1.2-2.1-1.3-2.5-1.3" fill="black"/>
              </svg>
            </div>
            {/* Google Pay */}
            <div className="w-12 h-8 bg-white rounded border border-gray-200 flex items-center justify-center p-1">
              <svg className="w-full h-full" viewBox="0 0 40 24" fill="none">
                <path d="M20 8c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6m0 2c-2.2 0-4 1.8-4 4s1.8 4 4 4 4-1.8 4-4-1.8-4-4-4" fill="#4285F4"/>
                <path d="M20 11c1.7 0 3 1.3 3 3s-1.3 3-3 3-3-1.3-3-3 1.3-3 3-3" fill="#34A853"/>
                <path d="M20 12.5c1 0 1.5.5 1.5 1.5s-.5 1.5-1.5 1.5-1.5-.5-1.5-1.5.5-1.5 1.5-1.5" fill="#FBBC05"/>
                <circle cx="20" cy="14" r="0.5" fill="#EA4335"/>
              </svg>
            </div>
          </div>
        </div>
